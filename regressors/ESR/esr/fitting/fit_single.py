...
def single_function(labels, basis_functions, likelihood, pmin=0, pmax=5, tmax=5, try_integration=False, verbose=False, Niter=30, Nconv=5, log_opt=False, return_params=False):
    ...
    Args:
        ...
        :return_params (bool, default=False): whether to return the parameters
    Returns:
         ...
         [:params (list): the best fitting parameters; only if return_params is set]
