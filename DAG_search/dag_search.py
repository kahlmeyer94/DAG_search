...
class DAGRegressor(sklearn.base.BaseEstimator, sklearn.base.RegressorMixin):
    ...
    def __init__(self, k:int = 1, n_calc_nodes:int = 5, max_orders:int = int(2e5), random_state:int = None, processes:int = 1, max_samples:int = 100, stop_thresh:float = 1e-20, mode : str = 'exhaustive', loss_fkt :DAG_Loss_fkt = R2_loss_fkt, max_time:float = 3600.0, positives:list = None, **kwargs):
        '''
        @Params:
            k.... number of constants
...
class PolySubRegressor(sklearn.base.BaseEstimator, sklearn.base.RegressorMixin):
    ...
    def __init__(self, random_state:int = None, regr_search = None, simpl_nodes:int = 2, topk:int = 2, max_orders:int = int(1e5), max_samples:int = 200, max_degree:int = 3, processes:int = 1, **kwargs):
        self.random_state = random_state
        self.processes = processes
        self.regr_search = regr_search
        self.regr_poly = None
