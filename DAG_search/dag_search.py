...
class DAGRegressorPoly(sklearn.base.BaseEstimator, sklearn.base.RegressorMixin):
    ...
    def __init__(self, random_state:int = None, simpl_nodes:int = 3, topk:int = 1, max_orders:int = int(1e5), max_degree:int = 3, max_tree_size:int = 30, max_samples:int = 300, processes:int = 1, **kwargs):
        self.random_state = random_state
