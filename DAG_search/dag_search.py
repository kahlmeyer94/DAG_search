...
class DAGRegressor(sklearn.base.BaseEstimator, sklearn.base.RegressorMixin):
    ...
    def __init__(self, k:int = 1, n_calc_nodes:int = 5, max_orders:int = int(5e5), random_state:int = None, processes:int = 1, max_samples:int = 100, stop_thresh:float = 1e-20, mode : str = 'exhaustive', loss_fkt :DAG_Loss_fkt = R2_loss_fkt, max_time:float = 1800.0, positives:list = None, pareto:bool = False, results:dict = {}, **kwargs):
        '''
        @Params:
            k.... number of constants
...
class DAGRegressorPoly(sklearn.base.BaseEstimator, sklearn.base.RegressorMixin):
    ...
    def __init__(self, random_state:int = None, simpl_nodes:int = 3, topk:int = 1, max_orders:int = int(1e5), max_degree:int = 3, max_tree_size:int = 20, max_samples:int = 1000, processes:int = 1, **kwargs):
        self.random_state = random_state
